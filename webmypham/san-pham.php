...
$sql_sanpham = "SELECT * FROM sanpham WHERE masanpham = ?";
$stmt_sanpham = $conn->prepare($sql_sanpham);
$stmt_sanpham->execute([$masanpham]);
$sanpham = $stmt_sanpham->fetch(PDO::FETCH_ASSOC);

$sql_cm = "SELECT * FROM chuyenmuc WHERE machuyenmuc = ?";
$stmt_cm = $conn->prepare($sql_cm);
$stmt_cm->execute([$sanpham['machuyenmuc']]);
$cm = $stmt_cm->fetch(PDO::FETCH_ASSOC);

$sql_sanphamlienquan = "SELECT * FROM sanpham WHERE machuyenmuc = ?";
$stmt_sanphamlienquan = $conn->prepare($sql_sanphamlienquan);
$stmt_sanphamlienquan->execute([$sanpham['machuyenmuc']]);
$sanphamlienquan = $stmt_sanphamlienquan->fetchAll(PDO::FETCH_ASSOC);
        ...
        <main class="inner-page-sec-padding-bottom">
            <div class="container">
              ...
              "asNavFor": ".product-slider-nav"
                            ...
                            <div class="single-slide">
                                <img src="http://localhost/webmypham/<?php echo $sanpham['anhchinh']; ?>" alt="">
                            </div>
                            <div class="single-slide">
                                <img src="http://localhost/webmypham/<?php echo $sanpham['anhphu1']; ?>" alt="">
                            </div>
                            <div class="single-slide">
                                <img src="http://localhost/webmypham/<?php echo $sanpham['anhphu2']; ?>" alt="">
                            </div>
                            <div class="single-slide">
                                <img src="http://localhost/webmypham/<?php echo $sanpham['anhphu3']; ?>" alt="">
                            </div>
                            <div class="single-slide">
                                <img src="http://localhost/webmypham/<?php echo $sanpham['anhphu4']; ?>" alt="">
                            </div>
                        </div>
            ...
            <section class="">
                ...
                {"breakpoint":480, "settings": {"slidesToShow": 1} }
                    ...
                    <?php foreach ($sanphamlienquan as $key => $row){ ?>
                        <div class="single-slide">
                            <div class="product-card">
                                ...
                                <div class="product-card--body">
                                    <div class="card-image">
                                        <img src="http://localhost/webmypham/<?php echo $row['anhchinh']; ?>" alt="" style="height: 350px;">
                                    </div>
                                    <div class="price-block">
    ...
    $(document).ready(function() {
        $('.themgiohang').click(function(event) {
            ...
            if(giohang == null){
                ...
                alert("Đã thêm Mỹ Phẩm vào giỏ hàng")
                location.reload();
                ...
                if(check != 0){
                    alert("Mỹ Phẩm đã có trong giỏ hàng!")
                }else{
                    var book = {
                        masanpham: '<?php echo $sanpham['masanpham'];?>',
                        tensanpham: '<?php echo $sanpham['tensanpham'];?>',
                    ...
                    alert('Thêm Mỹ Phẩm vào giỏ hàng thành công!')
                    location.reload();
