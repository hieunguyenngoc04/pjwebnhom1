...
$stmt_slide = $conn->query($sql_slide);
$slide = $stmt_slide->fetchAll(PDO::FETCH_ASSOC);

$sql_noibat = "SELECT * FROM sanpham WHERE loaisanpham = 2 ORDER BY masanpham DESC";
$stmt_noibat = $conn->query($sql_noibat);
$noibat = $stmt_noibat->fetchAll(PDO::FETCH_ASSOC);

$sql_moi = "SELECT * FROM sanpham WHERE loaisanpham = 3 ORDER BY masanpham DESC";
$stmt_moi = $conn->query($sql_moi);
$moi = $stmt_moi->fetchAll(PDO::FETCH_ASSOC);

$sql_danhchoban = "SELECT * FROM sanpham ORDER BY RAND() LIMIT 7";
$stmt_danhchoban = $conn->query($sql_danhchoban);
$danhchoban = $stmt_danhchoban->fetchAll(PDO::FETCH_ASSOC);
...
?>
                        ...
                        <div class="container">
                            <div class="home-content text-center text-sm-left position-relative">
                                <div class="hero-partial-image image-right">
                                    <img src="http://localhost/webmypham/<?php echo $row['anhchinh'] ?>" alt="" style="width: 720px; height: 509px;">
                                </div>
                ...
                <div class="row space-db--30">
                    <div class="col-lg-6 col-md-6 mb--30">
                        <a href="" class="promo-image promo-overlay">
                            <img width="540" height="183" src="https://thegioidohoa.com/wp-content/uploads/2018/12/thi%E1%BA%BFt-k%E1%BA%BF-banner-m%E1%BB%B9-ph%E1%BA%A9m-6.png" alt="">
                        </a>
                    </div>
                    <div class="col-lg-6 col-md-6 mb--30">
                        <a href="" class="promo-image promo-overlay">
                            <img width="540" height="183" src="https://intphcm.com/data/upload/banner-minh-hoa.jpg" alt="">
                        </a>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="product-card">
                                        ...
                                        <div class="product-card--body">
                                            <div class="card-image">
                                                <img src="http://localhost/webmypham/<?php echo $row['anhchinh']; ?>" alt="" style="width: 220px; height:220px; ">
                                                <div class="hover-contents">
                                                    <a href="san-pham.php?id=<?php echo $row['masanpham']; ?>" class="hover-image">
                                                        <img src="http://localhost/webmypham/<?php echo $row['anhphu1']; ?>" alt="" style="width: 220px; height:220px; ">
                                                    </a>
                                                </div>
                                            </div>
                    ...
                    <div class="col-lg-8 mb--30">
                        <div class="promo-wrapper promo-type-one">
                            <a href="#" class="promo-image  promo-overlay bg-image"
                                data-bg="">
                                <img src="https://treobangron.com.vn/wp-content/uploads/2022/09/banner-my-pham-34.jpg" alt="">
                            </a>
                    ...
                    <div class="col-lg-4 mb--30">
                        <div class="promo-wrapper promo-type-two ">
                            <a href="tat-ca-san-pham.php" class="promo-image promo-overlay bg-image"
                                data-bg="">
                                <img src="https://thietkehaithanh.com/wp-content/uploads/2019/01/thietkehaithanh-banner-my-pham-2-600x600.jpg" alt="" style="height: 245px;">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <section class="section-margin">
            <div class="container">
                ...
                <?php foreach ($danhchoban as $key => $row){ ?>
                    <div class="single-slide">
                        <div class="product-card">
                            <div class="product-header">
                                <a href="#" class="author">
